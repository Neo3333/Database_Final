...
def searchUpcomingFlights():
    ...
    if len(control_list)==0:
        ...
        query = "SELECT * \
				FROM (flight, airport as dept, airport as arr) \
				WHERE flight.departure_airport=dept.airport_name and flight.arrival_airport=arr.airport_name AND " + " AND ".join(control_list);
...
@app.route('/purchaseC1', methods=['GET', 'POST'])
def purchaseC1():
